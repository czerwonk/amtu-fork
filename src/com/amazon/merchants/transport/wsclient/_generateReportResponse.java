...
public class _generateReportResponse  implements java.io.Serializable {
    private com.amazon.merchants.transport.wsclient._OperationRequest operationRequest;
    private com.amazon.merchants.transport.wsclient.GenerateReportResult response;

    public _generateReportResponse() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.GenerateReportResult getResponse() {
        return response;
    }

    public void setResponse(com.amazon.merchants.transport.wsclient.GenerateReportResult response) {
        this.response = response;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _generateReportResponse)) return false;
        _generateReportResponse other = (_generateReportResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_generateReportResponse.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">generateReportResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "GenerateReportResult"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
    }
