/**
 * _getAllPendingDocumentInfo.java
 *
...
public class _getAllPendingDocumentInfo  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.GetAllPendingDocumentInfoRequest shared;
    private com.amazon.merchants.transport.wsclient.GetAllPendingDocumentInfoRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _getAllPendingDocumentInfo() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.GetAllPendingDocumentInfoRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.GetAllPendingDocumentInfoRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.GetAllPendingDocumentInfoRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.GetAllPendingDocumentInfoRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.GetAllPendingDocumentInfoRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.GetAllPendingDocumentInfoRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getAllPendingDocumentInfo)) return false;
        _getAllPendingDocumentInfo other = (_getAllPendingDocumentInfo) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getAllPendingDocumentInfo.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getAllPendingDocumentInfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "getAllPendingDocumentInfoRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
