/**
 * _getDocumentInfoInterfaceConformance.java
 *
...
public class _getDocumentInfoInterfaceConformance  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.GetDocumentInfoInterfaceConformanceRequest shared;
    private com.amazon.merchants.transport.wsclient.GetDocumentInfoInterfaceConformanceRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _getDocumentInfoInterfaceConformance() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.GetDocumentInfoInterfaceConformanceRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.GetDocumentInfoInterfaceConformanceRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.GetDocumentInfoInterfaceConformanceRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.GetDocumentInfoInterfaceConformanceRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.GetDocumentInfoInterfaceConformanceRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.GetDocumentInfoInterfaceConformanceRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getDocumentInfoInterfaceConformance)) return false;
        _getDocumentInfoInterfaceConformance other = (_getDocumentInfoInterfaceConformance) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getDocumentInfoInterfaceConformance.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getDocumentInfoInterfaceConformance"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "getDocumentInfoInterfaceConformanceRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
