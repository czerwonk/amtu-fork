/**
 * _getDocumentInfoListGivenTimeWindow.java
 *
...
public class _getDocumentInfoListGivenTimeWindow  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.GetDocumentInfoListGivenTimeWindowRequest shared;
    private com.amazon.merchants.transport.wsclient.GetDocumentInfoListGivenTimeWindowRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _getDocumentInfoListGivenTimeWindow() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.GetDocumentInfoListGivenTimeWindowRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.GetDocumentInfoListGivenTimeWindowRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.GetDocumentInfoListGivenTimeWindowRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.GetDocumentInfoListGivenTimeWindowRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.GetDocumentInfoListGivenTimeWindowRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.GetDocumentInfoListGivenTimeWindowRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getDocumentInfoListGivenTimeWindow)) return false;
        _getDocumentInfoListGivenTimeWindow other = (_getDocumentInfoListGivenTimeWindow) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getDocumentInfoListGivenTimeWindow.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getDocumentInfoListGivenTimeWindow"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "getDocumentInfoListGivenTimeWindowRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
