/**
 * _getDocumentInterfaceConformance.java
 *
...
public class _getDocumentInterfaceConformance  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.GetDocumentInterfaceConformanceRequest shared;
    private com.amazon.merchants.transport.wsclient.GetDocumentInterfaceConformanceRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _getDocumentInterfaceConformance() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.GetDocumentInterfaceConformanceRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.GetDocumentInterfaceConformanceRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.GetDocumentInterfaceConformanceRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.GetDocumentInterfaceConformanceRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.GetDocumentInterfaceConformanceRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.GetDocumentInterfaceConformanceRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getDocumentInterfaceConformance)) return false;
        _getDocumentInterfaceConformance other = (_getDocumentInterfaceConformance) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getDocumentInterfaceConformance.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getDocumentInterfaceConformance"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "getDocumentInterfaceConformanceRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
