/**
 * _getDocumentProcessingStatus.java
 *
...
public class _getDocumentProcessingStatus  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.GetDocumentProcessingStatusRequest shared;
    private com.amazon.merchants.transport.wsclient.GetDocumentProcessingStatusRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _getDocumentProcessingStatus() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.GetDocumentProcessingStatusRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.GetDocumentProcessingStatusRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.GetDocumentProcessingStatusRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.GetDocumentProcessingStatusRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.GetDocumentProcessingStatusRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.GetDocumentProcessingStatusRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getDocumentProcessingStatus)) return false;
        _getDocumentProcessingStatus other = (_getDocumentProcessingStatus) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getDocumentProcessingStatus.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getDocumentProcessingStatus"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "getDocumentProcessingStatusRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
