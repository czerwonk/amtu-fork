...
public class _getDocumentResponse  implements java.io.Serializable {
    private com.amazon.merchants.transport.wsclient._OperationRequest operationRequest;
    private com.amazon.merchants.transport.wsclient.GetDocumentResult response;

    public _getDocumentResponse() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.GetDocumentResult getResponse() {
        return response;
    }

    public void setResponse(com.amazon.merchants.transport.wsclient.GetDocumentResult response) {
        this.response = response;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getDocumentResponse)) return false;
        _getDocumentResponse other = (_getDocumentResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getDocumentResponse.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getDocumentResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "GetDocumentResult"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
    }
