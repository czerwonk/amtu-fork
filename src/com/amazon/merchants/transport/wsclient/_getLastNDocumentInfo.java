...
public class _getLastNDocumentInfo  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.GetLastNDocumentInfoRequest shared;
    private com.amazon.merchants.transport.wsclient.GetLastNDocumentInfoRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _getLastNDocumentInfo() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.GetLastNDocumentInfoRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.GetLastNDocumentInfoRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.GetLastNDocumentInfoRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.GetLastNDocumentInfoRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.GetLastNDocumentInfoRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.GetLastNDocumentInfoRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getLastNDocumentInfo)) return false;
        _getLastNDocumentInfo other = (_getLastNDocumentInfo) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getLastNDocumentInfo.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getLastNDocumentInfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "getLastNDocumentInfoRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
