/**
 * _getLastNDocumentInfoResponse.java
 *
...
public class _getLastNDocumentInfoResponse  implements java.io.Serializable {
    ...
    public _getLastNDocumentInfoResponse() {
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getLastNDocumentInfoResponse)) return false;
        _getLastNDocumentInfoResponse other = (_getLastNDocumentInfoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getLastNDocumentInfoResponse.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getLastNDocumentInfoResponse"));
