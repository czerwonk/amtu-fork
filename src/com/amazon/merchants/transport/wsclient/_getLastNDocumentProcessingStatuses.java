/**
 * _getLastNDocumentProcessingStatuses.java
 *
...
public class _getLastNDocumentProcessingStatuses  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.GetLastNDocumentProcessingStatusesRequest shared;
    private com.amazon.merchants.transport.wsclient.GetLastNDocumentProcessingStatusesRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _getLastNDocumentProcessingStatuses() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.GetLastNDocumentProcessingStatusesRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.GetLastNDocumentProcessingStatusesRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.GetLastNDocumentProcessingStatusesRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.GetLastNDocumentProcessingStatusesRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.GetLastNDocumentProcessingStatusesRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.GetLastNDocumentProcessingStatusesRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getLastNDocumentProcessingStatuses)) return false;
        _getLastNDocumentProcessingStatuses other = (_getLastNDocumentProcessingStatuses) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getLastNDocumentProcessingStatuses.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getLastNDocumentProcessingStatuses"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "getLastNDocumentProcessingStatusesRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
