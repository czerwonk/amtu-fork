/**
 * _getLastNPendingDocumentInfo.java
 *
...
public class _getLastNPendingDocumentInfo  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.GetLastNPendingDocumentInfoRequest shared;
    private com.amazon.merchants.transport.wsclient.GetLastNPendingDocumentInfoRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _getLastNPendingDocumentInfo() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.GetLastNPendingDocumentInfoRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.GetLastNPendingDocumentInfoRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.GetLastNPendingDocumentInfoRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.GetLastNPendingDocumentInfoRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.GetLastNPendingDocumentInfoRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.GetLastNPendingDocumentInfoRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getLastNPendingDocumentInfo)) return false;
        _getLastNPendingDocumentInfo other = (_getLastNPendingDocumentInfo) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getLastNPendingDocumentInfo.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getLastNPendingDocumentInfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "getLastNPendingDocumentInfoRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
