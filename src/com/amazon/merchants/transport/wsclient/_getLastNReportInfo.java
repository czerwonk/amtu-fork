...
public class _getLastNReportInfo  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.GetLastNReportInfoRequest shared;
    private com.amazon.merchants.transport.wsclient.GetLastNReportInfoRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _getLastNReportInfo() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.GetLastNReportInfoRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.GetLastNReportInfoRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.GetLastNReportInfoRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.GetLastNReportInfoRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.GetLastNReportInfoRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.GetLastNReportInfoRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getLastNReportInfo)) return false;
        _getLastNReportInfo other = (_getLastNReportInfo) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getLastNReportInfo.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getLastNReportInfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "getLastNReportInfoRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
