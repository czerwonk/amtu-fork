/**
 * _getLastNReportInfoResponse.java
 *
...
public class _getLastNReportInfoResponse  implements java.io.Serializable {
    private com.amazon.merchants.transport.wsclient._OperationRequest operationRequest;
    private com.amazon.merchants.transport.wsclient.ReportInfoArray response;

    public _getLastNReportInfoResponse() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.ReportInfoArray getResponse() {
        return response;
    }

    public void setResponse(com.amazon.merchants.transport.wsclient.ReportInfoArray response) {
        this.response = response;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getLastNReportInfoResponse)) return false;
        _getLastNReportInfoResponse other = (_getLastNReportInfoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getLastNReportInfoResponse.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getLastNReportInfoResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "ReportInfoArray"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
    }
