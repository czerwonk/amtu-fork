/**
 * _getMerchantInfoFromCustomerID.java
 *
...
public class _getMerchantInfoFromCustomerID  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.GetMerchantInfoFromCustomerIDRequest shared;
    private com.amazon.merchants.transport.wsclient.GetMerchantInfoFromCustomerIDRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _getMerchantInfoFromCustomerID() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.GetMerchantInfoFromCustomerIDRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.GetMerchantInfoFromCustomerIDRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.GetMerchantInfoFromCustomerIDRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.GetMerchantInfoFromCustomerIDRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.GetMerchantInfoFromCustomerIDRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.GetMerchantInfoFromCustomerIDRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getMerchantInfoFromCustomerID)) return false;
        _getMerchantInfoFromCustomerID other = (_getMerchantInfoFromCustomerID) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getMerchantInfoFromCustomerID.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getMerchantInfoFromCustomerID"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "getMerchantInfoFromCustomerIDRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
