/**
 * _getPendingDocumentInfoListGivenTimeWindow.java
 *
...
public class _getPendingDocumentInfoListGivenTimeWindow  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.GetPendingDocumentInfoListGivenTimeWindowRequest shared;
    private com.amazon.merchants.transport.wsclient.GetPendingDocumentInfoListGivenTimeWindowRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _getPendingDocumentInfoListGivenTimeWindow() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.GetPendingDocumentInfoListGivenTimeWindowRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.GetPendingDocumentInfoListGivenTimeWindowRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.GetPendingDocumentInfoListGivenTimeWindowRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.GetPendingDocumentInfoListGivenTimeWindowRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.GetPendingDocumentInfoListGivenTimeWindowRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.GetPendingDocumentInfoListGivenTimeWindowRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _getPendingDocumentInfoListGivenTimeWindow)) return false;
        _getPendingDocumentInfoListGivenTimeWindow other = (_getPendingDocumentInfoListGivenTimeWindow) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_getPendingDocumentInfoListGivenTimeWindow.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">getPendingDocumentInfoListGivenTimeWindow"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "getPendingDocumentInfoListGivenTimeWindowRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
