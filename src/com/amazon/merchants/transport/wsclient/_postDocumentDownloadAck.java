...
public class _postDocumentDownloadAck  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.PostDocumentDownloadAckRequest shared;
    private com.amazon.merchants.transport.wsclient.PostDocumentDownloadAckRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _postDocumentDownloadAck() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.PostDocumentDownloadAckRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.PostDocumentDownloadAckRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.PostDocumentDownloadAckRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.PostDocumentDownloadAckRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.PostDocumentDownloadAckRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.PostDocumentDownloadAckRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _postDocumentDownloadAck)) return false;
        _postDocumentDownloadAck other = (_postDocumentDownloadAck) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_postDocumentDownloadAck.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">postDocumentDownloadAck"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "postDocumentDownloadAckRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
