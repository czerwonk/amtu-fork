...
public class _postDocumentUnconfirmed  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedRequest shared;
    private com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _postDocumentUnconfirmed() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _postDocumentUnconfirmed)) return false;
        _postDocumentUnconfirmed other = (_postDocumentUnconfirmed) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_postDocumentUnconfirmed.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">postDocumentUnconfirmed"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "postDocumentUnconfirmedRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
