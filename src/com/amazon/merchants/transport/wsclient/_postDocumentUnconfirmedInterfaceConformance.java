/**
 * _postDocumentUnconfirmedInterfaceConformance.java
 *
...
public class _postDocumentUnconfirmedInterfaceConformance  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedInterfaceConformanceRequest shared;
    private com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedInterfaceConformanceRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _postDocumentUnconfirmedInterfaceConformance() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedInterfaceConformanceRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedInterfaceConformanceRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedInterfaceConformanceRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedInterfaceConformanceRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedInterfaceConformanceRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.PostDocumentUnconfirmedInterfaceConformanceRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _postDocumentUnconfirmedInterfaceConformance)) return false;
        _postDocumentUnconfirmedInterfaceConformance other = (_postDocumentUnconfirmedInterfaceConformance) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_postDocumentUnconfirmedInterfaceConformance.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">postDocumentUnconfirmedInterfaceConformance"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "postDocumentUnconfirmedInterfaceConformanceRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
