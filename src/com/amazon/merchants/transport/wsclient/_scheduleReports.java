...
public class _scheduleReports  implements java.io.Serializable {
    private java.lang.String subscriptionId;
    private java.lang.String validate;
    private java.lang.String XMLEscaping;
    private com.amazon.merchants.transport.wsclient.ScheduleReportsRequest shared;
    private com.amazon.merchants.transport.wsclient.ScheduleReportsRequest[] request;
    private java.lang.String credential;
    private java.lang.String signature;
    private java.util.Calendar timestamp;

    public _scheduleReports() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.ScheduleReportsRequest getShared() {
        return shared;
    }

    public void setShared(com.amazon.merchants.transport.wsclient.ScheduleReportsRequest shared) {
        this.shared = shared;
    }

    public com.amazon.merchants.transport.wsclient.ScheduleReportsRequest[] getRequest() {
        return request;
    }

    public void setRequest(com.amazon.merchants.transport.wsclient.ScheduleReportsRequest[] request) {
        this.request = request;
    }

    public com.amazon.merchants.transport.wsclient.ScheduleReportsRequest getRequest(int i) {
        return request[i];
    }

    public void setRequest(int i, com.amazon.merchants.transport.wsclient.ScheduleReportsRequest value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _scheduleReports)) return false;
        _scheduleReports other = (_scheduleReports) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_scheduleReports.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">scheduleReports"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "scheduleReportsRequest"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
