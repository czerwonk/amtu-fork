...
public class _scheduleReportsResponse  implements java.io.Serializable {
    private com.amazon.merchants.transport.wsclient._OperationRequest operationRequest;
    private com.amazon.merchants.transport.wsclient.ReportGenerationResponse response;

    public _scheduleReportsResponse() {
    }
    ...
    public com.amazon.merchants.transport.wsclient.ReportGenerationResponse getResponse() {
        return response;
    }

    public void setResponse(com.amazon.merchants.transport.wsclient.ReportGenerationResponse response) {
        this.response = response;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof _scheduleReportsResponse)) return false;
        _scheduleReportsResponse other = (_scheduleReportsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(_scheduleReportsResponse.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", ">scheduleReportsResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://xml.amazon.com/AWSMerchantService/2005-08-15", "ReportGenerationResponse"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
    }
